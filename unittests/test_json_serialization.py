...
from ahbicht.expressions.condition_nodes import EvaluatedFormatConstraint, EvaluatedFormatConstraintSchema
...
class TestJsonSerialization:
    ...
    def test_evaluated_format_constraint_evaluation(
