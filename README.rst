...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | ``int`` or ``str``, the number of the condition     | ``53``    |
| ` |                                                     |           |
| c |                                                     |           |
| o |                                                     |           |
| n |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | two parts of an expression combined by an operator  | ``([4]U[7 |
| ` | used in the context of the parsing and evaluation   | 6])O[5]`` |
| c | of the expression                                   | consists  |
| o |                                                     | of an     |
| m |                                                     | `         |
| p |                                                     | `and_comp |
| o |                                                     | osition`` |
...
|   |                                                     | ``[5]``   |
+---+-----------------------------------------------------+-----------+
| ` | an expression as given from the ahb Consists of at  | ``X[59]   |
| ` | least one single requirement indicator expression.  | U[53]``\  |
| a | In case of several model mark expressions the first | ``Muss[   |
| h | one will be evaluated and if not fulfilled, it will | 59]U([123 |
| b | be continued with the next one.                     | ]O[456])S |
|   |                                                     | oll[53]`` |
| e |                                                     |           |
| x |                                                     |           |
| p |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | An expression consisting of exactly one requirement | ``S       |
| ` | indicator and their respective condition            | oll[53]`` |
| s | expression. If there is only one requirement        |           |
| i | indicator in the ahb expression, then both          |           |
| n | expressions are identical.                          |           |
| g |                                                     |           |
| l |                                                     |           |
| e |                                                     |           |
|   |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | one or multiple conditions combined with or (in     | ``[1]``   |
| ` | case of FormatConstraints) also without operators   | ``[4]O[   |
| c | used as input for the condition parser              | 5]U[45]`` |
| o |                                                     |           |
| n |                                                     |           |
| d |                                                     |           |
| i |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | Is returned after the evaluation of the             | ``[901    |
| ` | RequirementConstraints consist only of              | ]X[954]`` |
| f | FormatConstraints                                   |           |
| o |                                                     |           |
| r |                                                     |           |
| m |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | The Merkmal/modal_mark or Operator/prefix_operator  | ``Muss``, |
| ` | of the data element/data element                    | ``Soll``, |
| r | group/segment/segment group.                        | ``Kann``, |
| e |                                                     | ``X``,    |
| q |                                                     | ``O``,    |
| u |                                                     | ``U``     |
| i |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | as defined by the EDI Energy group (see             | ``Muss``, |
| ` | `edi-energy.de → Dokumente → Allgemeine             | ``Soll``, |
| M | Festlegungen <https://www.edi-energy.de/inde        | ``Kann``  |
| e | x.php?id=38&tx_bdew_bdew%5Buid%5D=956&tx_bdew_bdew% |           |
| r | 5Baction%5D=download&tx_bdew_bdew%5Bcontroller%5D=D |           |
| k | okument&cHash=ae3c1bd6fe3f664cd90f5e94f9714e3e>`__) |           |
| m | Stands alone or before a condition expression, can  |           |
| a | be the start of several requirement indicator       |           |
| l | expressions in one ahb expression                   |           |
| ` |                                                     |           |
| ` |                                                     |           |
| / |                                                     |           |
| ` |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | Is required for the correct structure of the        |           |
| ` | message If the following condition is not           |           |
| M | fulfilled, the information **must not** be given.   |           |
| u |                                                     |           |
| s |                                                     |           |
| s |                                                     |           |
| ` |                                                     |           |
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | Is required for technical reasons. Always followed  |           |
| ` | by a condition. If the following condition is not   |           |
| S | fulfilled, the information **must not** be given.   |           |
| o |                                                     |           |
| l |                                                     |           |
| l |                                                     |           |
| ` |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | Operator which does not function to combine         | ``X``,    |
| ` | conditions, but as requirement indicator. Stands    | ``O``,    |
| p | alone or in front of a condition expression.        | ``U``     |
| r |                                                     |           |
| e |                                                     |           |
| f |                                                     |           |
| i |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | Defines the nodes of the tree as they are passed,   | ``Requir  |
| ` | evaluated und returned. There are different kinds   | ementCons |
| C | of conditions (``Bedingung``, ``Hinweis``,          | traint``, |
| o | ``Format``) as defined by the EDI Energy group (see | ``F       |
| n | `edi-energy.de → Dokumente → Allgemeine             | ormatCons |
| d | Festlegungen <https://www.edi-energy.de/inde        | traint``, |
| i | x.php?id=38&tx_bdew_bdew%5Buid%5D=956&tx_bdew_bdew% | ``Hint``, |
| t | 5Baction%5D=download&tx_bdew_bdew%5Bcontroller%5D=D | ``Eval    |
| i | okument&cHash=ae3c1bd6fe3f664cd90f5e94f9714e3e>`__) | uatedComp |
| o | and also a ``EvaluatedComposition`` after a         | osition`` |
| n | composition of two nodes is evaluated.              |           |
| N |                                                     |           |
| o |                                                     |           |
| d |                                                     |           |
| e |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | - are true or false, has to be determined - keys    | “falls    |
| ` | between ``[1]`` and ``[499]``                       | SG        |
| B |                                                     | 2+IDE+CCI |
| e |                                                     | == EHZ”   |
| d |                                                     |           |
| i |                                                     |           |
...
| ) |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | - just a hint, even if it is worded like a          | “Hinweis: |
| ` | condition - keys from ``[500]`` onwards, starts     | ‘ID der   |
| H | with ‘Hinweis:’                                     | Messl     |
| i |                                                     | okation’” |
| n |                                                     | “Hinweis: |
| w |                                                     | ‘Es ist   |
| e |                                                     | der alte  |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | - a constraint for how the data should be given -   | “Format:  |
| ` | keys between ``[901]`` and ``[999]``, starts with   | Muss      |
| F | ‘Format:’ Format Constraints are “collected” while  | größer 0  |
| o | evaluating the rest of the tree, meaning the        | sein”     |
| r | evaluated composition of the Mussfeldprüfung        | “Format:  |
| m | contains an expression that consists only of format | max 5     |
| a | constraints.                                        | Nachkomm  |
| t |                                                     | astellen” |
| d |                                                     |           |
| e |                                                     |           |
| f |                                                     |           |
...
| ) |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | A format constraint that is just “collected” during |           |
| ` | the requirement constraint evaluation. To have a    |           |
| U | clear separation of conditions that affect whether  |           |
| n | a field is mandatory or not and those that check    |           |
| e | the format of fields without changing their state   |           |
| v | it will become a part of the                        |           |
| a | ``format_constraint_expression`` which is part of   |           |
| l | the ``EvaluatedComposition``.                       |           |
| u |                                                     |           |
| a |                                                     |           |
| t |                                                     |           |
| e |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | An evaluatable FormatConstraint will (other than    |           |
| ` | the ``UnevaluatedFormatConstraint``) be evaluated   |           |
| E | by e.g. matching a regex, calculating a checksum    |           |
| v | etc. This happens *after* the Mussfeldprüfung.      |           |
| a | (*details to be added upon implementing*)           |           |
| l |                                                     |           |
| u |                                                     |           |
| a |                                                     |           |
| t |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | is returned after a composition of two nodes is     |           |
| ` | evaluated                                           |           |
| E |                                                     |           |
| v |                                                     |           |
| a |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | Hints and UnevaluatedFormat Constraints are seen as |           |
| ` | neutral as they don’t have a condition to be        |           |
| n | fulfilled or unfulfilled and should not change the  |           |
| e | requirement outcome. See truth table below.         |           |
| u |                                                     |           |
| t |                                                     |           |
| r |                                                     |           |
| a |                                                     |           |
...
| ` |                                                     |           |
+---+-----------------------------------------------------+-----------+
| ` | If the condition can be fulfilled but we don’t know | “Wenn     |
| ` | (yet) if it is or not. See truth table below.       | v         |
| u |                                                     | orhanden” |
| n |                                                     |           |
| k |                                                     |           |
| n |                                                     |           |
